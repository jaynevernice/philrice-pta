...
@section('content')
    <main class="p-4 md:ml-64 h-auto pt-20">
        ...
        <div class="grid grid-cols-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
            ...
            <div class="border-2 mx-auto rounded-lg bg-slate-100 shadow-lg dark:border-gray-600 h-32 md:h-64">
                <div id="chart1"></div>
            </div>
            ...
            <div class="border-2 rounded-lg bg-slate-100 shadow-lg dark:border-gray-600 h-32 md:h-64">
                <div id="chart3"></div>
            </div>
