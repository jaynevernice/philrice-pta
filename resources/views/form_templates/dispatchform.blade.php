    ...
    <div class="container w-full flex flex-wrap mx-auto px-2 mt-16">
        ...
        <section class="w-full lg:w-4/5">
            ...
            <h1 class="flex items-center font-sans font-bold break-normal text-gray-700 px-2 text-xl mt-12 lg:mt-0 md:text-2xl">
                PhilRice CES Technical Dispatch Monitoring
			</h1>
            ...
            <div class="p-8 mt-6 lg:mt-0 leading-normal rounded shadow bg-white">
                <blockquote class="border-l-4 border-yellow-600 italic my-4 pl-8 md:pl-12">
                    Technical dispatch refers to opportunities to improve the competence of our partners and other rice stakeholders (non-PhilRice staff) by serving as their resource person/expert on a topic related to rice or work at PhilRice.
                    <br><br>
            ...
            {{-- Section 2 --}}
            <hr class="bg-gray-300 my-12">
            <h2 class="font-sans font-bold break-normal text-gray-700 px-2 pb-8 text-xl">PhilRice CES Offices/Division</h2>
            ...
            {{-- Section 3 --}}
            <hr class="bg-gray-300 my-12">
            <h2 class="font-sans font-bold break-normal text-gray-700 px-2 pb-8 text-xl">Personal Information</h2>
            ...
            {{-- Section 4 --}}
            <hr class="bg-gray-300 my-12">
            <h2 class="font-sans font-bold break-normal text-gray-700 px-2 pb-8 text-xl">Details of Technical Dispatch</h2>
            <div id='section4' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
                <form>

                    {{-- Title of Event/Activity --}}
                    <div class="gap-6 mb-6">
                        <label for="event_title" class="block mb-2 text-sm font-medium text-gray-900">Title of Event</label>
                        <p class="text-sm text-gray-500 mb-2">Write full title of event</p>
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2">    
                        <div>                   
                            ...
                            <p class="text-sm text-gray-500 mb-2">If one-day event, start and end date are the same.</p>
                    ...
                    {{-- Nature of Technical Dispatch--}}
                    <div class="gap-6 mb-6">
                        <label for="nature_of_dispatch" class="block mb-2 text-sm font-medium text-gray-900">Nature of Technical Dispatch</label>  
                        <p class="text-sm text-gray-500 mb-2">Served as resource person or expert to develop/improve the competence of rice stakeholders/partners during what type of event?</p>     
                        <div class="relative">
                            <select class="block appearance-none w-full bg-gray-50 border border-gray-300 text-gray-900 py-3 px-4 pr-8 rounded-lg leading-tight focus:outline-none focus:bg-white focus:border-gray-500 text-sm" id="nature_of_dispatch">
                                <option selected disabled>Select</option>
                                ...
                                <option>Coaching/Mentoring Session</option>
                                <option>Field day or farm walk</option>
                                <option>Other</option>
                            </select>
                        </div>
                    </div>
                    
                    {{-- Name of Organizer/Requesting Party --}}
                    <div class="gap-6 mb-6">
                        <label for="organizer_name" class="block mb-2 text-sm font-medium text-gray-900">Name of Organizer/Requesting Party</label>
                        <p class="text-sm text-gray-500 mb-2">Specify the name/s of the agency/office/organization that requested you as resource person or expert.</p>   
                        <input type="text" id="organizer_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Name of Organizer/Requesting Party" required>
                    </div>

                    {{-- Mode of Sharing and Venue of Event --}}
                    ...
                    <div>
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-2">
                            <div class="flex items-center ps-4 border border-gray-200 rounded">
                                <input id="bordered-radio-1" type="radio" value="Face-to-Face" name="mos_group" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-2">
                                <label for="bordered-radio-1" class="w-full py-4 ms-2 text-sm font-medium text-gray-900">Face-to-Face</label>
                            </div>
                            <div class="flex items-center ps-4 border border-gray-200 rounded">
                                <input checked id="bordered-radio-2" type="radio" value="Online/Virtual" name="mos_group" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-2">
