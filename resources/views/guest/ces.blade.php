...
@section('content')
    ...
    <main class="p-4 md:ml-64 h-screen pt-20">
        ...
        <div class="grid grid-cols-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
            <div id="chart1" class="bg-slate-100 shadow-lg border-2 mx-auto rounded-l dark:border-gray-600 h-32 md:h-64">
            </div>
...
{{-- @section('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const closeButton = document.querySelectorAll('[data-modal-toggle]');
