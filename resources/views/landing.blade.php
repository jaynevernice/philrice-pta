        ...
        <div class="relative flex-1">
            ...
            <div class="absolute inset-0 flex flex-col justify-center items-center text-white">
                ...
                <div class="max-w-4xl mx-auto mt-8 px-4">
                    ...
                    <p class="text-lg text-center mb-6">{{ config('app.name') }} efficiently organizes and manages
                ...
                <div class="flex flex-row">
                    <a href="{{ route('guest.overview') }}">
                        <button type="button"
                            class="flex items-center justify-center w-60 text-gray-900 bg-white hover:bg-slate-100 border border-gray-300 focus:outline-none focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-base text-center px-5 py-3 me-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">
                    ...
                    <a href="{{ route('login') }}">
                        <button type="button"
                            class="flex items-center justify-center w-60 text-gray-900 bg-green-300 hover:bg-green-400 border border-green-300 focus:outline-none focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-base text-center px-5 py-3 me-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">
