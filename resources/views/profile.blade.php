    ...
    <aside
        ...
        <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
            <ul class="space-y-2">
                ...
                {{-- CES --}}
                <li>
                    <a class="exclude-from-confirm flex items-center p-2 w-full text-base font-medium text-[#0B1215] rounded-lg transition duration-75 group hover:bg-green-100 dark:text-white dark:hover:bg-green-700"
...
@section('content')
    ...
    <main class="p-8 md:ml-64 pt-24 h-full bg-gray-50">
        ...
        <div class="relative px-20 py-2 mb-10 shadow-md rounded-2xl bg-white mx-auto border-solid border-2 border-gray-100">
        ...
        document.getElementById('goBackBtn').addEventListener('click', function(event) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    var redirectUrl = "";
                    if (userType === 'encoder') {
                        redirectUrl = "{{ route('encoder.overview') }}";
                    } else if (userType === 'admin') {
                        redirectUrl = "{{ route('admin.overview') }}";
                    } else if (userType === 'super_admin') {
                        redirectUrl = "{{ route('super_admin.overview') }}";
                    }
