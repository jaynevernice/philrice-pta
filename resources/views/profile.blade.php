    ...
    <main class="p-4 h-screen pt-1 bg-gray-100 flex items-center justify-center">
        <div class="w-full max-w-4xl">
            ...
            <div class="border-b border-gray-200 dark:border-gray-700">
                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400 bg-white rounded-t-lg">
                    <li class="me-2">
                        <a href="#" class="tab-link inline-flex items-center justify-center p-4 text-blue-600 border-b-2 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500 group bg-gray-200" aria-current="page" data-tab="profile">
                            <box-icon type='solid' name='user-account' color="#2563eb" class="mr-2"></box-icon>
                            Profile
                        </a>
                    </li>
                    <li class="me-2">
                        <a href="#" class="tab-link inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group" data-tab="security">
                            <box-icon name='question-mark' color="#9ca3af" class="mr-2" ></box-icon>
                            Security Questions
                        </a>
                    </li>
                    <li class="me-2">
                        <a href="#" class="tab-link inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group" data-tab="update_pass">
            ...
            <div id="profile" class="tab-content drop-shadow-lg bg-white p-4 flex border w-full flex-wrap">
                ...
                <div class="mx-auto my-8 sm:mx-10 sm:my-10">
                    <div class="relative flex items-center justify-center">
                        <label for="profile_photo" class="h-40 w-40 rounded-full bg-gray-100 relative cursor-pointer border border-gray-900 overflow-visible">
                            
                            {{-- Placeholder for current profile photo --}}
                            <img src="{{ asset('assets/icon.jpg') }}" alt="Current Profile Photo" class="h-full w-full object-cover">
                ...
                <div class="flex flex-col">
                    ...
                    <div class="flex">
                        <div class="my-2 mx-1 flex-1">
                            ...
                            <input type="email" name="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="PhilRice ID" disabled>
                        </div>
                        <div class="my-2 mx-1 flex-1">
                            <label for="philrice_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email</label>
                            <input type="text" name="philrice_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Email">
                        </div>
                    </div>
                    ...
                    <div class="flex">
                        <div class="my-2 mx-1 flex-1">
                            ...
                            <select disabled class="block appearance-none w-full h-10 border border-gray-300 text-gray-900 py-3 px-4 pr-8 rounded-lg leading-tight focus:outline-none focus:bg-white focus:border-gray-500 text-sm" id="station" required>
                        ...
                        <div class="my-2 mx-1 flex-1">
                            <label for="station" class="block text-sm font-medium text-gray-900 mb-1">Position</label> 
                            <select disabled class="block appearance-none w-full h-10 border border-gray-300 text-gray-900 py-3 px-4 pr-8 rounded-lg leading-tight focus:outline-none focus:bg-white focus:border-gray-500 text-sm" id="station" required>
                    ...
                    {{-- Division --}}
                    {{-- <div class="flex">
                        <div class="mr-1 my-2 flex-1" id="divisionField">
                            <label for="division" class="block text-sm font-medium text-gray-900 mb-1">Division</label> 
                            <select disabled class="block appearance-none w-full h-10 border border-gray-300 text-gray-900 py-3 px-4 pr-8 rounded-lg leading-tight focus:outline-none focus:bg-white focus:border-gray-500 text-sm" id="division" required>
                                <option selected disabled>Division</option>
                                <option>TMSD</option>
                            </select>
                        </div>
                    ...
                    {{-- Position --}}
                    {{-- <div class="flex">
                        <div class="mr-1 my-2 flex-1" id="positionField">
                            <label for="position" class="block text-sm font-medium text-gray-900 mb-1">Position</label> 
                            <select disabled class="block appearance-none w-full h-10 border border-gray-300 text-gray-900 py-3 px-4 pr-8 rounded-lg leading-tight focus:outline-none focus:bg-white focus:border-gray-500 text-sm" id="position" required>
                                <option selected disabled>Position</option>
            ...
            <div id="update_pass" class="hidden tab-content drop-shadow-lg bg-white p-4 flex border w-full flex-wrap">
                <div class="my-2 w-full">
                    ...
                    <input type="password" name="old_password" id="old_password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="•••••••••">
                </div>                        
                <div class="my-2 w-full">
                    <label for="new_password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Password</label>
                    <input type="password" name="new_password" id="new_password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="•••••••••">
                </div>                        
                <div class="my-2 w-full">
                    <label for="confirm_new_password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Confirm password</label>
                    <input type="password" name="confirm_new_password" id="confirm_new_password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="•••••••••">
                </div>
                {{-- Show Password --}}
    ...
    <script>
        ...
        tabs.forEach(tab => {
            tab.addEventListener('click', () => {
                ...
                tabs.forEach(tab => {
                    tab.classList.remove('border-blue-600', 'text-blue-600', 'bg-gray-200', 'border-transparent');
                    tab.querySelector('box-icon').setAttribute('color', '#9ca3af'); // Set default color
                }); // Remove active classes from all tabs
                tab.classList.add('border-blue-600', 'text-blue-600', 'bg-gray-200'); // Add active classes to the clicked tab
