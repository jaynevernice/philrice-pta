...
@section('title')
<title>Super Admin | PhilRice Negros</title>
@endsection
    ...
    <ul class="space-y-2">
      ...
      <li>
        ...
        <ul id="dropdown-sales" class="hidden py-2 space-y-2">
          ...
          <li>
            <a href="{{ route('super_admin.ces_add') }}" class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-green-100 dark:text-white dark:hover:bg-green-700">
      ...
      {{-- NEGROS --}}
      <li>
        <a href="{{ route('super_admin.negros') }}" class="bg-green-100 flex items-center p-2 text-base font-medium text-gray-900 rounded-lg  dark:text-white hover:bg-green-100 dark:hover:bg-gray-700 group">
          <box-icon name='building' type='solid'></box-icon>
...
<main class="p-4 md:ml-64 h-auto pt-20">
  ...
  {{-- Station --}}
  <div class="flex">        
    <h1 class="text-3xl font-extrabold text-gray-900 dark:text-white md:text-3xl lg:text-4xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">PhilRice</span> Negros</h1>
  </div>
