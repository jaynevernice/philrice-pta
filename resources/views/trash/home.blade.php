        ...
        <div class="grid grid-cols-2 lg:grid-cols-4">          
          ...
          <div class="max-w-xs bg-white border border-gray-200 rounded-lg shadow m-2">
            <a href="{{ route('trainingsform.index') }}" target="_blank" >
                <img class="rounded-t-lg" src={{ asset('assets/form1.jpg') }} alt="" />
                <div class="p-5">
                    <h5 class="mb-4 text-xl font-bold leading-tight text-gray-900">Summary of Trainings Conducted</h5>
                </div>
            </a>
          </div>
            ...
            <div class="max-w-xs bg-white border border-gray-200 rounded-lg shadow m-2">
                <a href="{{ route('kslform.index') }}" target="_blank" >
                    <img class="rounded-t-lg" src={{ asset('assets/form1.jpg') }} alt="" />
                    <div class="p-5">
                        <h5 class="mb-4 text-xl font-bold leading-tight text-gray-900">KSL Monitoring</h5>
                    </div>
                </a>
            </div>
            ...
            <div class="max-w-xs bg-white border border-gray-200 rounded-lg shadow m-2">
                <a href="{{ route('dispatchform.index') }}" target="_blank">
                    <img class="rounded-t-lg" src={{ asset('assets/form1.jpg') }} alt="" />
                    <div class="p-5">
                        <h5 class="mb-4 text-xl font-bold leading-tight text-gray-900">Technical Dispatch Monitoring</h5>
                    </div>
                </a>
            </div>
            ...
            <div class="max-w-xs bg-white border border-gray-200 rounded-lg shadow m-2 opacity-50">
                <a href="#" target="_blank" class="cursor-not-allowed">
                    <img class="rounded-t-lg" src={{ asset('assets/form1.jpg') }} alt="" />
                    <div class="p-5">
                        <h5 class="mb-4 text-xl font-bold leading-tight text-gray-900">Techno Demo Monitoring</h5>
                    </div>
                </a>
            </div>
